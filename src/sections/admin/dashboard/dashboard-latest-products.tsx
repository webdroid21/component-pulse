...
export function DashboardLatestProducts({ title, subheader, list, sx, ...other }: Props) {
    return (
        <Card sx={sx} {...other}>
            ...
            <Scrollbar sx={{ minHeight: 384 }}>
                ...
                >
                    ...
                    {list.length === 0 && (
                        <Box sx={{ color: 'text.secondary', textAlign: 'center', py: 5 }}>
                            No products found.
                        </Box>
                    )}
                </Box>
        ...
        >
            ...
            >
                <Link
                    ...
                    href={paths.admin.products.edit(item.id)}
                    noWrap
