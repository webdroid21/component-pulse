...
const CHECKOUT_STORAGE_KEY = 'component-pulse-checkout';
const CHECKOUT_STEPS = ['Cart', 'Shipping & Address', 'Payment'];
...
function CheckoutContainer({ children }: CheckoutProviderProps) {
  ...
  const activeStep = pathname.includes(paths.checkout)
