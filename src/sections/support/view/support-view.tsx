    ...
    >
      <Container>
        ...
        <Typography variant="body1" sx={{ mx: 'auto', maxWidth: 640, opacity: 0.8 }}>
          Get the help you need to succeed with your embedded systems projects. Our comprehensive
          support includes technical assistance, documentation, and community resources.
        </Typography>
      </Container>
    </Box>
  );
    ...
    <Box sx={{ mb: { xs: 10, md: 15 } }}>
      <Box sx={{ textAlign: 'center', mb: 8 }}>
        ...
        <Typography sx={{ color: 'text.secondary', maxWidth: 480, mx: 'auto' }}>
          Choose the support option that best fits your needs. Our team is here to help you every
          step of the way.
        </Typography>
      </Box>
    ...
    >
      <Box
        sx={{
          ...
          bgcolor: (theme) =>
            iconColor
              ? theme.vars.palette[iconColor as 'primary' | 'info' | 'warning'].lighter
              : 'background.neutral',
        }}
      >
    ...
    <Box>
      ...
      <Box sx={{ maxWidth: 800, mx: 'auto' }}>
        {faqs.map((faq, index) => (
          <Accordion
            key={faq.question}
            sx={{ mb: 2, '&:before': { display: 'none' }, borderRadius: 1 }}
          >
            <AccordionSummary
