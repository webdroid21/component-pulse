      ...
      <Container>
        <Box sx={{ textAlign: 'center', mb: { xs: 8, md: 10 } }}>
          ...
          <Typography sx={{ color: 'text.secondary', maxWidth: 640, mx: 'auto' }}>
            Our comprehensive training program is designed to take you from beginner to professional
            embedded systems developer with real-world experience.
          </Typography>
        </Box>
    ...
    >
      <Box
        sx={{
          ...
          bgcolor: (theme) =>
            theme.vars.palette[item.color as 'primary' | 'info' | 'success' | 'warning' | 'error']
              .lighter,
        }}
      >
