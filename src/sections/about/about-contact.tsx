          ...
          <Grid size={{ xs: 12, md: 4 }}>
            ...
            >
              <Iconify
                ...
                width={48}
                sx={{ color: 'primary.main', mx: 'auto', mb: 3 }}
              />
          ...
          <Grid size={{ xs: 12, md: 4 }}>
            ...
            >
              <Iconify
                ...
                width={48}
                sx={{ color: 'info.main', mx: 'auto', mb: 3 }}
              />
              <Typography variant="h6" sx={{ mb: 1 }}>
                Call Us
              </Typography>
          ...
          <Grid size={{ xs: 12, md: 4 }}>
            ...
            >
              <Iconify
                ...
                width={48}
                sx={{ color: 'warning.main', mx: 'auto', mb: 3 }}
              />
              <Typography variant="h6" sx={{ mb: 1 }}>
                Email Us
              </Typography>
        ...
        >
          <Box sx={{ mb: { xs: 3, md: 0 }, maxWidth: 540 }}>
            ...
            <Typography sx={{ opacity: 0.8 }}>
              Browse our extensive catalog of electronic components or get in touch for personalized
              recommendations.
            </Typography>
          </Box>
